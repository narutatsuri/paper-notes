...
read: 2026-08-04
appraisal: solid
appraisal_note: Recasts self-distillation as a dynamically changing shrinkage power-iteration that progressively sparsifies the kernel basis, predicting an under-fitting collapse after a few rounds — a mechanism that explains, not just fits, the gain.
